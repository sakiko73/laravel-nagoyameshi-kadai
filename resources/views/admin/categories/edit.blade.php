            ...
            <div class="col-xl-7 col-lg-8 col-md-9">
                <nav class="mb-4" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.categories.index') }}">店舗一覧</a></li>
                        <li class="breadcrumb-item active"><a href="{{ route('admin.categories.show', $restaurant) }}">店舗詳細</a></li>
                ...
                <form method="POST" action="{{ route('admin.categoriess.update', $restaurant) }}" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
